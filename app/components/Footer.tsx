    ...
    <footer className="border-t border-navy-700 bg-navy-900 px-6 pt-16 pb-8 text-white">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="space-y-5 lg:col-span-1">
          {/* Logo + Título estilo Header (Sin círculo blanco) */}
          ...
          <div className="flex items-center gap-4 pt-1">
            ...
            <a
              ...
              aria-label="Facebook"
              className="flex h-11 w-11 items-center justify-center rounded-full border border-navy-700 bg-navy-700/40 text-white transition-all hover:border-gold hover:text-gold"
            >
      ...
      {/* Disclaimer legal */}
      <div className="mx-auto mt-12 max-w-7xl border-t border-navy-700 pt-6">
      ...
      {/* Copyright */}
      <div className="mx-auto mt-6 flex max-w-7xl flex-col items-center justify-between gap-2 border-t border-navy-700 pt-6 text-center sm:flex-row sm:text-left">
